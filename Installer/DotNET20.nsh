...
!macro CheckDotNET DotNetReqVer
  !define DOTNET_URL "http://www.fishman.com/downloads/dotnetfx.exe"
...
NoDotNET:
    ...
    ".NET Framework not installed.$\nRequired Version: $7 or greater.$\nDownload the Required .NET Framework?" \
    /SD IDYES IDYES DownloadDotNET IDNO GiveUpDotNET ;IDCANCEL
OldDotNET:
    MessageBox MB_YESNO|MB_ICONEXCLAMATION \
...
DownloadDotNET:
  ...
  DetailPrint "Please wait, this will take a moment..."
